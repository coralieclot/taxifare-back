...
def preprocess(min_date:str = '2009-01-01', max_date:str = '2015-01-01') -> None:
    ...
    table_name = f'processed_{DATA_SIZE}'
    load_data_to_bq(data_processed_with_timestamp, GCP_PROJECT, BQ_DATASET, table_name, truncate=True)
...
def train(
    ...
    data_processed = get_data_with_cache(GCP_PROJECT,
                                         query,
                                         data_processed_cache_path,
                                         data_has_header=False)

    if data_processed.shape[0] < 65:
